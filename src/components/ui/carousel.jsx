...
export function Carousel({ slides }) {
  ...
  return (
    <div className="relative w-[70vmin] h-[50vmin] mx-auto" aria-labelledby={`carousel-heading-${id}`}>
      <ul
      ...
      <div className="absolute flex justify-center mt-[-10px] w-full top-[calc(100%+1rem)]">
